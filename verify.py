...
def verify_v2(signed_local_json, signed_local_file):
    verify_response = []
    verified = False


    valid_proof = utils.validate_proof(signed_local_json['blockchainreceipt']['proof'],
                         signed_local_json['blockchainreceipt']['targetHash'],
                         signed_local_json['blockchainreceipt']['merkleRoot'], sha256)
    print(valid_proof)
